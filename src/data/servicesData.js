...
export const brandLogos = {
    ...
    "D-Link": "/logos/download.png", // Note: might need better logo
    ...
    "ZKTeco": "/logos/download.png", // Note: might need specific logo
    ...
    "Jabra": "/logos/download.png", // Note: might need specific logo
...
// Updated services data with only the brands from the provided logos
export const servicesData = [
    {
        category: "Computers & Laptops",
        brands: ["HP", "Dell", "Lenovo", "ASUS", "Apple", "Microsoft", "Fujitsu", "IBM"]
    },
    {
        category: "Monitors, Displays & TVs",
        brands: ["HP", "Samsung", "ASUS", "Dell", "Lenovo", "Philips"]
    },
    {
        category: "Computer Accessories",
        brands: ["Apple", "Logitech", "HP", "Dell", "Lenovo", "Microsoft", "UGREEN", "Jabra"]
    },
    {
        category: "Networking & Communication",
        brands: ["HP", "TP-Link", "D-Link", "Cisco", "Schneider"]
    },
    {
    ...
    },
    {
        ...
        brands: ["HP", "Epson", "Canon", "Zebra", "Honeywell", "Fujitsu"]
    },
    {
    ...
    {
        category: "Storage & Graphics",
        brands: ["Seagate", "Western Digital", "Samsung", "ASUS"]
    },
    {
        category: "Power & Backup",
        brands: ["APC", "Eaton", "Schneider"]
    },
    {
        category: "Networking Equipment",
        brands: ["Cisco", "TP-Link", "D-Link", "Belden", "Commscope", "Panduit"]
    },
    {
        category: "Security & Access Control",
        brands: ["IDEMIA", "Suprema", "Bosch", "Honeywell", "ZKTeco", "Hikvision", "eSSL", "BioMax", "HID", "3M", "Philips"]
    },
    {
        category: "Audio/Video",
        brands: ["Logitech", "Cisco", "Jabra", "Samsung", "Philips", "Epson"]
    }
];

// Get all unique brands across all categories
export const getAllBrands = () => {
    const allBrands = servicesData.flatMap(cat => cat.brands);
...
export const getBrandsByCategory = (category) => {
    ...
    const categoryData = servicesData.find(cat => cat.category === category);
    return categoryData ? categoryData.brands : [];
};

// Get all category names
export const getCategories = () => {
    return ["All", ...servicesData.map(cat => cat.category)];
};

// Get all brands with their logos for display
